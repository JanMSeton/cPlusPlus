...
class Strings
{
    ...
    public:
        ...
        Strings(); // init d_size and *d_arr
        Strings(int argc, char *argv[]); // init d_size with argc and **d_arr with argv, fill argv // uses new
    ...
    private:
        void fill(char *ntbs[]);                    // fill prepared d_arr
